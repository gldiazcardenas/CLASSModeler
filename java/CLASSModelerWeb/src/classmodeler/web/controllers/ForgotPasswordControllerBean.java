  ...
  public String process() {
    ...
    if (isAllValid()) {
      try {
        ...
        addInformationMessage(JSFMessageBean.GENERAL_MESSAGE_ID, JSFResourceBundle.getLocalizedMessage("FORGOT_PASSWORD_CONFIRMATION_MESSAGE"), null);
      }
        ...
        if (e.getType() == EInvalidAccountErrorType.NON_EXISTING_ACCOUNT) {
          ...
          addErrorMessage(JSFMessageBean.GENERAL_MESSAGE_ID, JSFResourceBundle.getLocalizedMessage("INVALID_ACCOUNT_DEACTIVATED_MESSAGE"), null);
        }
        else {
          // Should not happen
        ...
        addErrorMessage(JSFMessageBean.GENERAL_MESSAGE_ID, JSFResourceBundle.getLocalizedMessage("SEND_RESET_PASSWORD_EMAIL_MESSAGE"), null);
      }
    }
