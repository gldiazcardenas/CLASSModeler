  ...
  public String process() {
    ...
    if (isAllValid()) {
      try {
        ...
        addInformationMessage(JSFMessageBean.GENERAL_MESSAGE_ID, GenericUtils.getLocalizedMessage("FORGOT_PASSWORD_CONFIRMATION_MESSAGE"), null);
      }
        ...
        addErrorMessage(JSFMessageBean.GENERAL_MESSAGE_ID, GenericUtils.getLocalizedMessage("SEND_RESET_PASSWORD_EMAIL_MESSAGE"), null);
      }
    }
