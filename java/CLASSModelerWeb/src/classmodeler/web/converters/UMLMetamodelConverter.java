 ...
 */
public final class UMLMetamodelConverter {
  
  private UMLMetamodelConverter() {
   ...
   * @return
   */
  public static Model convertToUML (SharedDiagram diagram) {
...
//  
   ...
   * @return
   */
  public static List<mxCell> getExtendedClassifiers (mxCell classifier) {
   ...
   * @return
   */
  public static List<mxCell> getImplementedInterfaces (mxCell classifier) {
